...
public class ResturentForgotPassword extends AppCompatActivity {
    ...
    private void clickListener() {
        ...
        bt_Backhome_reset.setOnClickListener(v -> {
            ...
            Intent iReg=new Intent(ResturentForgotPassword.this, ResturentLoginActivity.class);
            startActivity(iReg);
    ...
    private void resetPassword() {
        ...
        firebaseAuth.sendPasswordResetEmail(email).addOnCompleteListener(task -> {
            if(task.isSuccessful()){
                Toast.makeText(ResturentForgotPassword.this,"Check your email to reset your password!", Toast.LENGTH_LONG).show();

                Intent iReg=new Intent(ResturentForgotPassword.this, ResturentLoginActivity.class);
                startActivity(iReg);
            }
            else {
                Toast.makeText(ResturentForgotPassword.this,"Try again! Something wrong happened", Toast.LENGTH_LONG).show();
            }
        });
    }
}