...
public class ResturentProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.resturent_profile);
        ...
        pref = new PrefManager(ResturentProfile.this);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if(!doc.getData().get("uImage").toString().equals("")){
                        Glide.with(ResturentProfile.this)
        ...
        imgResturent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iImage = new Intent(ResturentProfile.this, ResProductImg.class);
        ...
        btnRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myDB.collection("ResturentReg").document(pref.getUserId()).update("uFirstName",etFirstNameReg.getText().toString(),"uLastName",etLastNameReg.getText().toString(),"uAddress",etAddressReg.getText().toString(),"uAboutUs",etDescription.getText().toString(),"uMobile",etMobileReg.getText().toString())
                        .addOnSuccessListener(new OnSuccessListener<Void>() {

                            @Override
                            public void onSuccess(Void aVoid) {
                                Intent i = new Intent(ResturentProfile.this, ResturentDashboard.class);
                                startActivity(i);
                            }
